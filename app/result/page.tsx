  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-300 mb-6">Końcowe wyniki i klasyfikacja turnieju.</p>
        
        <div className="bg-[#1a1a1a] rounded-lg p-6 border border-[#333]">
          <div className="text-center py-12">
            <p className="text-gray-400 mb-4">Funkcja wyników będzie dostępna wkrótce.</p>
            <p className="text-sm text-gray-500">
              Tutaj będzie można przeglądać podium, klasyfikację końcową i nagrody.
            </p>
          </div>
        </div>
      </div>
